...
interface MyRankExtended extends MyRank {
  totalPoints?: number;
  tasksCompleted?: number;
}
...
const Leaderboard = () => {
  ...
  const [entries, setEntries] = useState<LeaderboardEntryExtended[]>([]);
  const [myRank, setMyRank] = useState<MyRankExtended | null>(null);
